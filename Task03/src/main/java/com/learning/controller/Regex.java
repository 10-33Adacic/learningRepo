...
public interface Regex {
    ...
    String REGEX_LAST_NAME_UKR = "^[[А-ЩЬЮЯҐІЇЄ][а-щьюяґіїє']+(-[А-ЩЬЮЯҐІЇЄ]?[а-щьюяґіїє'])?]+" +
            "|([А-ЩЬЮЯҐІЇЄ]?[а-щьюяґіїє']+ +[А-ЩЬЮЯҐІЇЄ][а-щьюяґіїє'](-[А-ЩЬЮЯҐІЇЄ]?[а-щьюяґіїє'])?){1,20}$";
    String REGEX_FIRST_NAME = "^[[A-Za-z]+('’-[A-Za-z])?]+$";
    String REGEX_FIRST_NAME_UKR = "^[[[А-ЩЬЮЯҐІЇЄа-щьюяґіїє']+('’-[А-ЩЬЮЯҐІЇЄа-щьюяґіїє'])?]+$";
    ...
    String REGEX_GROUP = "^[A-Za-z_]{1,15}$";
